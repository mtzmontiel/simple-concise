...
public class ItemBean implements Serializable
{
   ...
   public String delete()
   {
      ...
      try
      {
         ...
         Container container = deletableEntity.getContainer();
         container.getItems().remove(deletableEntity);
         deletableEntity.setContainer(null);
         this.entityManager.merge(container);
   ...
   private Predicate[] getSearchPredicates(Root<Item> root)
   {
      ...
      Container container = this.example.getContainer();
      if (container != null)
      {
         predicatesList.add(builder.equal(root.get("container"), container));
      }
